...
<template>
  <li>
    <router-link
      :to="item.route"
      class="group relative flex items-center gap-3 rounded-sm py-2 px-4 font-light duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 text-white"
